...
function Home({ onCreateGame, onJoinGame, onEditQuestions }) {
  ...
  const { handlePlayerNameChange, playerName } = usePlayerName();
  ...
  const handleCreateGame = () => {
    ...
    onCreateGame();
    navigate("/create-game", { state: { playerName } });
  };
  ...
  return (
    <div className="container">
      <div className="content">
        ...
        <button className="button" onClick={handleEditQuestions}>
          Questions adminsitrations
        </button>
